...
ElasticSearchClient.prototype.multisearch = function (commands, options, cb) {
    // Pull the callback and set it false to not clobber id.
    if (typeof arguments[arguments.length - 1] === 'function') {
        cb = arguments[arguments.length - 1];
        arguments[arguments.length - 1] = false;
    ...
    var serializedCommands = commands.map(function (command) {
...
ElasticSearchClient.prototype.bulk = function (commands, options, cb) {
    // Pull the callback and set it false to not clobber id.
    if (typeof arguments[arguments.length - 1] === 'function') {
        cb = arguments[arguments.length - 1];
        arguments[arguments.length - 1] = false;
